            ...
            <ScrollView style={styles.container}>
                <View >
                    ...
                    <View style={styles.userImgView}>
                        ...
                        <Text style={styles.contentText}>이름: {this.state.item.name}</Text>
                        ...
                        <Text style={styles.contentText}>주소: {this.state.item.ar}</Text>
                        <Text style={styles.contentText}>생일: {this.state.item.bir}</Text>
                    </View>
                </View>
            </ScrollView>
        );
